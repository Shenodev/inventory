...
export const routeMeta: RouteMeta = {
  ...
  meta: [
    {
      name: 'description',
      content: 'Cookie policy for ShenoInventory — essential cookies only, no tracking, manage your consent.',
    },
  ],
};
  ...
  template: `
    <div class="mx-auto max-w-3xl px-6 py-10">
      ...
      <nav aria-label="Breadcrumb" class="mt-2 flex items-center gap-1.5 text-xs text-slate-500">
        ...
        <span aria-current="page" class="text-slate-300">Legal · Cookie Policy</span>
      </nav>
